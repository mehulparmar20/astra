                                        ...
                                        <div class="switch-toggle">
                                            ...
                                            <div class="mt-1">
                                                <a class="bg-img bg-img1" href="javascript:void(0);"><img
                                                        src="https://laravel8.spruko.com/noa/assets/images/media/bg-img1.jpg" alt="Bg-Image" id="bgimage1"></a>
                                                <a class="bg-img bg-img2" href="javascript:void(0);"><img
                                                        src="https://laravel8.spruko.com/noa/assets/images/media/bg-img2.jpg" alt="Bg-Image" id="bgimage2"></a>
                                                <a class="bg-img bg-img3" href="javascript:void(0);"><img
                                                        src="https://laravel8.spruko.com/noa/assets/images/media/bg-img3.jpg" alt="Bg-Image" id="bgimage3"></a>
                                                <a class="bg-img bg-img4" href="javascript:void(0);"><img
                                                        src="https://laravel8.spruko.com/noa/assets/images/media/bg-img4.jpg" alt="Bg-Image" id="bgimage4"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
		...
		<div id="global-loader">
			<img src="https://laravel8.spruko.com/noa/assets/images/loader.svg" class="loader-img" alt="Loader">
		</div>
		<!-- /GLOBAL-LOADER -->
            ...
            <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <!-- sidebar-toggle-->
                        <a class="logo-horizontal " href="https://laravel8.spruko.com/noa/index">
                            <img src="https://laravel8.spruko.com/noa/assets/images/brand/Astra_logo.png" class="header-brand-img desktop-logo" alt="logo">
                            <img src="https://laravel8.spruko.com/noa/assets/images/brand/logo-3.png" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a class="nav-link icon text-center country-nav-link" data-bs-target="#country-selector" data-bs-toggle="modal">
												<img class="header-icons language" alt="" src="https://laravel8.spruko.com/noa/assets/images/flags/us_flag.jpg">
											</a>
                                        </div>
                                        <!-- SEARCH -->
												...
												<div class="px-2 pb-4 pt-2">
													<div class="row mb-2">
														...
														<div class="col d-flex p-0">
															<a href="https://laravel8.spruko.com/noa/calendar2" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="https://laravel8.spruko.com/noa/mail-inbox" class="dropdown-menu-item text-muted source-logo-container">
													...
													<div class="row mb-2">
														<div class="col d-flex">
															<a href="https://laravel8.spruko.com/noa/chat" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="https://laravel8.spruko.com/noa/products" class="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <div class="dropdown  d-flex shopping-cart">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a class="dropdown-item d-flex p-4" href="https://laravel8.spruko.com/noa/cart">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/ecommerce/1.jpg"></span>
													...
													<a class="dropdown-item d-flex p-4" href="https://laravel8.spruko.com/noa/cart">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/ecommerce/2.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
													...
													<a class="dropdown-item d-flex p-4" href="https://laravel8.spruko.com/noa/cart">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/ecommerce/3.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
													...
													<a class="dropdown-item d-flex p-4" href="https://laravel8.spruko.com/noa/cart">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/ecommerce/4.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
													...
													<a class="dropdown-item d-flex p-4" href="https://laravel8.spruko.com/noa/cart">
                                                        <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/ecommerce/5.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
										...
										<div class="dropdown d-md-flex message">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
												...
												<div class="message-menu ps2 overflow-hidden">
													<a class="dropdown-item d-flex" href="https://laravel8.spruko.com/noa/chat">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/users/1.jpg"></span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="https://laravel8.spruko.com/noa/chat">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/users/15.jpg">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="https://laravel8.spruko.com/noa/chat">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/users/12.jpg">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="https://laravel8.spruko.com/noa/chat">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="https://laravel8.spruko.com/noa/assets/images/users/4.jpg">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
                                        ...
                                        <div class="dropdown d-md-flex notifications">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
												...
												<div class="notifications-menu ps3 overflow-hidden">
													<a class="dropdown-item" href="https://laravel8.spruko.com/noa/chat">
													...
													<a class="dropdown-item" href="https://laravel8.spruko.com/noa/cart">
														<div class="notification-each d-flex">
													...
													<a class="dropdown-item" href="https://laravel8.spruko.com/noa/blog-details">
														<div class="notification-each d-flex">
										...
										<div class="dropdown d-md-flex profile-1">
											<a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="https://laravel8.spruko.com/noa/assets/images/faces/6.jpg" alt="profile-user"
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
												<a class="dropdown-item" href="https://laravel8.spruko.com/noa/profile">
												...
												<a class="dropdown-item" href="https://laravel8.spruko.com/noa/mail-compose">
												...
												<a class="dropdown-item" href="https://laravel8.spruko.com/noa/mail-inbox">
												...
												<a class="dropdown-item" href="https://laravel8.spruko.com/noa/faq">
												...
												<a class="dropdown-item" href="https://laravel8.spruko.com/noa/login">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="https://laravel8.spruko.com/noa/index">
                            <img src="https://laravel8.spruko.com/noa/assets/images/brand/Astra_logo.png" class="header-brand-img desktop-logo" alt="logo">
                            <img src="https://laravel8.spruko.com/noa/assets/images/brand/logo-1.png" class="header-brand-img toggle-logo" alt="logo">
                            <img src="https://laravel8.spruko.com/noa/assets/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">
                            <img src="https://laravel8.spruko.com/noa/assets/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">
                        </a><!-- LOGO -->
                    </div>
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/form-elements" class="slide-item">Form Elements</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/form-layouts" class="slide-item">Form Layouts</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/form-validation" class="slide-item">Form Validation</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/form-advanced" class="slide-item">Form Advanced</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/wysiwyag" class="slide-item">Form Editors</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/form-editable" class="slide-item">Form editable</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/form-wizard" class="slide-item">Form Wizard</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/tables" class="slide-item">Default Table</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/datatable" class="slide-item">Data Tables</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/table-editable" class="slide-item">Editable Tables</a></li>
                                </ul>
                            </li>
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide" href="https://laravel8.spruko.com/noa/landing" target="_blank">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/chart-echart" class="slide-item"> ECharts</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/chart-chartjs" class="slide-item">Chart Js</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/chart-flot" class="slide-item"> Flot Charts</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/chart-morris" class="slide-item"> Morris Charts</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/chart-nvd3" class="slide-item">Nvd3 Charts</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/icons" class="slide-item">Font Awesome</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons2" class="slide-item"> Material Design Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons3" class="slide-item"> Simple Line Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons4" class="slide-item"> Feather Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons5" class="slide-item"> Ionic Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons6" class="slide-item"> Flag Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons7" class="slide-item"> pe7 Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons8" class="slide-item"> Themify Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons9" class="slide-item">Typicons Icons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/icons10" class="slide-item">Weather Icons</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/maps1" class="slide-item">Leaflet Maps</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/maps2" class="slide-item">Mapel Maps</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/maps" class="slide-item">Vector Maps</a></li>
                                </ul>
                            </li>
                            <li>
                                <h3>Submenu's</h3>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/calendar2" class="slide-item">Calendar</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/chat" class="slide-item">Chat</a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                class="sub-side-menu__label">E-Commerce</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/cart">Cart</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/checkout">Checkout</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/products">Products</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/product-details">Product-Details</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/wishlist">Wishlist</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/file-manager">Files</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/file-manager1">File Manager</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/file-manager2">File Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/mail-inbox">Inbox</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/mail-compose">Compose Mail</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/mail-read">Read Mail</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/mail-settings">Mail Settings</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/invoice-list">Invoice List</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/invoice-details">Invoice Details</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/invoice-create">Create Invoice</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/invoice-timelog">Time Log Invoice</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/invoice-edit">Edit Invoice</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/projects">Projects</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/projects-list">Projects List</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/project-details">Project Details</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/project-new">Project New</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/project-edit">Edit Project</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="https://laravel8.spruko.com/noa/ticket-details" class="slide-item"><span class="side-menu__label">Tickets</span></a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                class="sub-side-menu__label">Tasks</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/tasks-list">Task List</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/task-edit">Edit Task</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/task-create">Create Task</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/clients">Clients</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/client-create">Add Client</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/alerts" class="slide-item">Alerts</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/avatar" class="slide-item">Avatar</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/badge" class="slide-item">Badges</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/breadcrumbs" class="slide-item">Breadcrumbs</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/buttons" class="slide-item">Buttons</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/colors" class="slide-item">Colors</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/dropdown" class="slide-item">Dropdown</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/gallery" class="slide-item">Gallery</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/loaders" class="slide-item">Loaders</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/navigation" class="slide-item">Navigation</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/notify" class="slide-item">Notifications</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/offcanvas" class="slide-item">Offcanvas</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/pagination" class="slide-item">Pagination</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/panels" class="slide-item">Panels</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/rangeslider" class="slide-item">Range Slider</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/scroll" class="slide-item">Scroll</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/tags" class="slide-item">Tags</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/thumbnails" class="slide-item">Thumbnails</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/treeview" class="slide-item">Treeview</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/typography" class="slide-item">Typography</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/accordion" class="slide-item">Accordions</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/carousel" class="slide-item">Carousel</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/cards" class="slide-item">Cards</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/counters" class="slide-item">Counters</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/modal" class="slide-item">Modals</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/timeline" class="slide-item">Timeline</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/sweetalert" class="slide-item">Sweet-Alerts</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/rating" class="slide-item">Rating</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/mediaobject" class="slide-item">Media Object</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/tabs" class="slide-item">Tabs</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/tooltipandpopover" class="slide-item">Tooltip and Popover</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/progress" class="slide-item">Progress Bars</a></li>

                                    <li><a href="https://laravel8.spruko.com/noa/footers" class="slide-item">Footers</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/users-list" class="slide-item">Users List</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/file-attachments" class="slide-item">File Attachments</a></li>
                                </ul>
                            </li>
                            <li>
                                <h3>Pages</h3>
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/login">Sign In</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/register">Sign Up</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/forgot-password">Forgot Password</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/lockscreen">Lockscreen</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/construction">UnderConstruction</a></li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                ...
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/error404">404 Error</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/error500">500 Error</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/error501">501 Error</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="https://laravel8.spruko.com/noa/settings" class="slide-item">Settings</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/profile" class="slide-item">Profile</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/about" class="slide-item">About Company</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/services" class="slide-item">Services</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/switcher" class="slide-item">Switcher</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/terms" class="slide-item">Terms</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/faq" class="slide-item">Faq's</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/pricing" class="slide-item">Pricing</a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                                class="sub-side-menu__label">Blog</span><i
                                                class="sub-angle fa fa-angle-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/blog">Blog</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/blog-details">Blog Details</a></li>
                                            <li><a class="sub-slide-item" href="https://laravel8.spruko.com/noa/blog-edit">Edit Post</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="https://laravel8.spruko.com/noa/background" class="slide-item">Background</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/border" class="slide-item">Border</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/display" class="slide-item">Display</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/flex" class="slide-item">Flex</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/height" class="slide-item">Height</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/margin" class="slide-item">Margin</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/padding" class="slide-item">Padding</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/position" class="slide-item">Position</a></li>
                                    <li><a href="https://laravel8.spruko.com/noa/width" class="slide-item">Width</a></li>
                            ...
                            <ul class="row row-sm p-3">
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block active">
                                        <span class="country-selector"><img alt="unitedstates" src="https://laravel8.spruko.com/noa/assets/images/flags/us_flag.jpg" class="me-2 language"></span>United States
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="italy" src="https://laravel8.spruko.com/noa/assets/images/flags/italy_flag.jpg" class="me-2 language"></span>Italy
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="spain" src="https://laravel8.spruko.com/noa/assets/images/flags/spain_flag.jpg" class="me-2 language"></span>Spain
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="india" src="https://laravel8.spruko.com/noa/assets/images/flags/india_flag.jpg" class="me-2 language"></span>India
                                </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="french" src="https://laravel8.spruko.com/noa/assets/images/flags/french_flag.jpg" class="me-2 language"></span>French
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="russia" src="https://laravel8.spruko.com/noa/assets/images/flags/russia_flag.jpg" class="me-2 language"></span>Russia
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="germany" src="https://laravel8.spruko.com/noa/assets/images/flags/germany_flag.jpg" class="me-2 language"></span>Germany
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="argentina" src="https://laravel8.spruko.com/noa/assets/images/flags/argentina_flag.jpg" class="me-2 language"></span>Argentina
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="uae" src="https://laravel8.spruko.com/noa/assets/images/flags/uae_flag.jpg" class="me-2 language"></span>UAE
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="austria" src="https://laravel8.spruko.com/noa/assets/images/flags/austria_flag.jpg" class="me-2 language"></span>Austria
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="mexico" src="https://laravel8.spruko.com/noa/assets/images/flags/mexico_flag.jpg" class="me-2 language"></span>Mexico
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="china" src="https://laravel8.spruko.com/noa/assets/images/flags/china_flag.jpg" class="me-2 language"></span>China
                                </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="poland" src="https://laravel8.spruko.com/noa/assets/images/flags/poland_flag.jpg" class="me-2 language"></span>Poland
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="canada" src="https://laravel8.spruko.com/noa/assets/images/flags/canada_flag.jpg" class="me-2 language"></span>Canada
                                    </a>
                                </li>
                                <li class="col-lg-4 mb-2">
                                    <a class="btn btn-country btn-lg btn-block">
                                        <span class="country-selector"><img alt="malaysia" src="https://laravel8.spruko.com/noa/assets/images/flags/malaysia_flag.jpg" class="me-2 language"></span>Malaysia
                                    </a>
                                </li>
                            </ul>
                        </div>
