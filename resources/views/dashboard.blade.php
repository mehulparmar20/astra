...
@include('layout.dashboard.switcher')
@include('loader')
...
@include('layout.dashboard.top_menu')   
@include('layout.dashboard.side_menu')          
                                                ...
                                                <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                                                    ...
                                                    <tbody class="table-body">
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(https://laravel8.spruko.com/noa/assets/images/users/11.jpg)"></span>
                                                            ...
                                                            <td class="text-muted fs-13"><a href="https://laravel8.spruko.com/noa/project-details" class="text-dark">Noa Dashboard UI</a></td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(https://laravel8.spruko.com/noa/assets/images/users/12.jpg)"></span>
                                                                    <div class="user-details ms-2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(https://laravel8.spruko.com/noa/assets/images/users/13.jpg)"></span>
                                                                    <div class="user-details ms-2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(https://laravel8.spruko.com/noa/assets/images/users/4.jpg)"></span>
                                                                    <div class="user-details ms-2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(https://laravel8.spruko.com/noa/assets/images/users/5.jpg)"></span>
                                                                    <div class="user-details ms-2">
						...
						<div class="row">
							...
							<div class="col-md-12 d-flex mb-4">
								...
								<div class="m-0 wp-70 text-dark d-flex align-items-center">
									<div class="me-2">
										<img alt="User Avatar" class="rounded-circle avatar-sm" src="https://laravel8.spruko.com/noa/assets/images/users/7.jpg">
									</div>
									<div>
										...
										<tbody>
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-md" src="https://laravel8.spruko.com/noa/assets/images/users/8.jpg">
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-md" src="https://laravel8.spruko.com/noa/assets/images/users/2.jpg">
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-md" src="https://laravel8.spruko.com/noa/assets/images/users/11.jpg">
														</div>
														<div>
											...
											<tr class="row-last">
												<td>
													<div class="d-flex align-items-center">
														<div class="me-2">
															<img alt="User Avatar" class="rounded-circle avatar-lg" src="https://laravel8.spruko.com/noa/assets/images/users/14.jpg">
														</div>
														<div>
								...
								<div class="row">
									<div class="mt-5">
										<div class="media mb-5 overflow-visible">
											<div class="me-3">
												<a href="https://laravel8.spruko.com/noa/profile"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="https://laravel8.spruko.com/noa/assets/images/users/5.jpg"> </a>
											</div>
											<div class="media-body overflow-visible">
												...
												<div class="media mb-5 overflow-visible">
													<div class="me-3">
														<a href="https://laravel8.spruko.com/noa/profile"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="https://laravel8.spruko.com/noa/assets/images/users/2.jpg"> </a>
													</div>
   ...
   <!-- LaodBoard      -->
		...
		<div class="modal fade" id="LaodBoard">
			<div class="modal-dialog modal-dialog-centered task-view-modal" role="document">
				<div class="modal-content modal-content-demo">

					<div class="modal-header p-5">
						<h4 class="modal-title text-dark">LoadBoard</h4><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
