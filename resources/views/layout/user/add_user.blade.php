                                ...
                                <div class="table-responsive export-table">
                                    <form method="post"> @csrf <input type="hidden" name="_token" id="csrf" value="{{Session::token()}}">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputFirstName4">First Name <span class="required"></span>
                                            </label>
                                            <input type="text" class="form-control" name="inputFirstName4" id="inputFirstName4" placeholder="First Name">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="inputLastName4">Last Name <span class="required"></span>
                                            </label>
                                            <input type="text" class="form-control" name="inputLastName4" id="inputLastName4" placeholder="Last Name">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="inputUsername4">Username <span class="required"></span>
                                            </label>
                                            <input type="text" class="form-control" name="inputUsername4" id="inputUsername4" placeholder="Username">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail4">Email <span class="required"></span>
                                            </label>
                                        ...
                                        <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4">Password <span class="required"></span>
                                            </label>
                                            <input type="password" class="form-control" name="inputPassword4" id="inputPassword4" placeholder="Password">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="inputAddress">Address <span class="required"></span>
                                            </label>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="tel" class="form-control telephone4" name="inputTelephone" id="inputTelephone">
                                        </div>
                                        <div class="form-group col-md-2">
